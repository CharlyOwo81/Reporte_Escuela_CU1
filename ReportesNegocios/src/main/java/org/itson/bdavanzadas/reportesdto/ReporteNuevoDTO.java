...
public class ReporteNuevoDTO {
    ...
    public ReporteNuevoDTO(Alumno alumno, Docente docente, NivelIncidencia nivelIncidencia, String descripcion, String motivo, Calendar fechaHora, boolean notificado) {
        this.alumno = alumno;
