...
/**
 * Clase que gestiona la conexión a la base de datos MongoDB y proporciona métodos para abrir y cerrar la conexión, así como para obtener la base de datos de Expediente.
...
public class ConexionMongo {
    ...
    private static final String nombreBd = "Expediente";
